...
Item {
  ...
  Rectangle {
    ...
    color: plasmoid.configuration.theming == 0 ? "#262643" : plasmoid.configuration.theming == 1 ? "#ECEDEE" : PlasmaCore.Theme.backgroundColor
    radius: 10
    Rectangle {
      id: topCorner
      visible: true
  ...
  Item {
    Rectangle {
      ...
      radius: 6
      color: plasmoid.configuration.theming == 0 ? "transparent" : plasmoid.configuration.theming == 1 ? "#FFFFFF" : PlasmaCore.Theme.viewBackgroundColor
      Image {
        id: searchIcon
