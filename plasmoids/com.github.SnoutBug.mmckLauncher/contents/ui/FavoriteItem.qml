...
Item {
  ...
  Rectangle {
    ...
    z: -20
    color: plasmoid.configuration.theming == 0 ? "#181829" : plasmoid.configuration.theming == 1 ? "#E0E1E3" : PlasmaCore.Theme.buttonBackgroundColor
    ...
    State {
      ...
      PropertyChanges { target: rect; color: plasmoid.configuration.theming == 0 ? "#181829" : plasmoid.configuration.theming == 1 ? "#F7F7F7" : PlasmaCore.Theme.buttonBackgroundColor }
    }]
